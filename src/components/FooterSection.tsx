      ...
      <div className="container max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-[#25D366] hover:text-[#20BD5A] transition-colors group mb-4"
          >
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-[#E4405F] hover:text-[#C13584] transition-colors group"
          >
            <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
            ...
            <span className="font-body text-sm group-hover:underline">@shisha.cool.lounge</span>
          </a>
        </motion.div>
      </div>
