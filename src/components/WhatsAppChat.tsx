  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 z-50 w-80 rounded-2xl bg-background border border-border shadow-2xl overflow-hidden"
          >
            {/* Header */}
      ...
      <motion.button
        ...
        className="fixed bottom-4 right-4 z-50 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg flex items-center justify-center hover:bg-[#20BD5A] transition-colors"
